...
static void semver_parse_test(void)
{
	...
	g_assert_true(semver_parse(version_string, version, &pre_release, &build, &error));
	g_assert_no_error(error);
	...
	g_assert_false(semver_parse(version_string, version, &pre_release, &build, &error));
...
static void semver_less_equal_test(void)
{
	...
	/* test "relaxed" semantic versions */
	g_assert_true(semver_less_equal("0", "3.2.1", &error));
	g_assert_true(semver_less_equal("3", "3.2.1", &error));
	g_assert_true(semver_less_equal("3.2", "3.2.1", &error));
	g_assert_false(semver_less_equal("4", "3.2.1", &error));

	/* core version comparisons */
	g_assert_true(semver_less_equal("3.2.1", "3.2.1", &error));
	g_assert_false(semver_less_equal("3.2.2", "3.2.1", &error));
	g_assert_true(semver_less_equal("3.2.2", "3.3.1", &error));
	g_assert_false(semver_less_equal("4.2.2", "3.3.1", &error));

	/* lexicographic pre_releases */
	g_assert_true(semver_less_equal("3.2.1-foo", "3.2.1-foo", &error));
	g_assert_true(semver_less_equal("3.2.1-foo", "3.2.1", &error));
	g_assert_true(semver_less_equal("3.2.1-foo", "3.2.1-goo", &error));
	g_assert_false(semver_less_equal("3.2.1-foop", "3.2.1-foo", &error));

	/* numerical/dot-separated pre_releases */
	g_assert_true(semver_less_equal("3.2.1-1.2.3", "3.2.1-1.2.3", &error));
	g_assert_true(semver_less_equal("3.2.1-123", "3.2.1-123", &error));
	g_assert_false(semver_less_equal("3.2.1-124", "3.2.1-123", &error));
	g_assert_true(semver_less_equal("3.2.1-23", "3.2.1-123", &error));
	g_assert_true(semver_less_equal("3.2.1-23.0.1", "3.2.1-123.0.12", &error));
	g_assert_true(semver_less_equal("3.2.1-23.0.111111", "3.2.1-123.0.12", &error));

	/* mixed */
	g_assert_true(semver_less_equal("3.2.1-1.abc", "3.2.1-1.abc", &error));
	g_assert_false(semver_less_equal("3.2.1-1.abz", "3.2.1-1.abc", &error));
	g_assert_true(semver_less_equal("3.2.1-1.abc.1", "3.2.1-1.abc.2", &error));
	g_assert_false(semver_less_equal("3.2.1-1.abc.3", "3.2.1-1.abc.2", &error));
	g_assert_false(semver_less_equal("3.2.1-1abc.3", "3.2.1-1000.3", &error));
	g_assert_true(semver_less_equal("3.2.1-1999.3", "3.2.1-1abc.3", &error));

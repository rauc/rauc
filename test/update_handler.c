...
int main(int argc, char *argv[])
{
	UpdateHandlerTestPair testpair_matrix[] = {
		...
		{"ext4", "tar", TEST_UPDATE_HANDLER_NO_IMAGE_FILE | TEST_UPDATE_HANDLER_EXPECT_FAIL,G_SPAWN_EXIT_ERROR, 2},
		...
		{"vfat", "tar", TEST_UPDATE_HANDLER_DEFAULT, 0, 0},
		{"vfat", "tar", TEST_UPDATE_HANDLER_NO_IMAGE_FILE | TEST_UPDATE_HANDLER_EXPECT_FAIL, G_SPAWN_EXIT_ERROR, 2},

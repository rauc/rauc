...
/**
 * @brief Sets barebox state variables based on a key->value list.
 *
 * @param pairs GPtrArray of "var=value" strings to set as barebox state variables.
...
/* This freezes the remaining attempts counter in barebox by setting the attempts_locked variable */

...
Doing this would be possible in a slots post-install hook, for example.
...
contained in the bundles trust chain.
...
hook script.
This variable will contain space-separated list of the hashes in the same order
